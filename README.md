# Example C++ Application using OpenSSL [![Build Status](https://travis-ci.org/ingvildbro/openssl-example.svg?branch=master)](https://travis-ci.org/ingvildbro/openssl-example)
